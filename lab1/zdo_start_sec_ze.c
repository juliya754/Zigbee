...
// change address {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01} -> {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02}
zb_ieee_addr_t g_ieee_addr = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02};
